...
def exec_dmer(arg_repeat, i_file, i_cluster):
  ...
  my_versions = []
  my_versions.append("heft")
  # my_versions.append("greedy-randomized-constructive-heuristic")
  # my_versions.append("grch")
  # my_versions.append("cplex")
  # my_versions.append("mpi-lb")
  # my_versions.append("mpi-pthread-lb")
  # my_versions.append("mpi-openmp-lb")
  # my_versions.append("mpi")
  # my_versions.append("mpi-pthread")
  # my_versions.append("mpi-openmp")
...
def exec_batch(arg_versions,
  ...
  for version in arg_versions:
    ...
    command = "../shell/run-" + version + "2.sh"
...
ttt_name = "CyberShake_30"
file_name = "CyberShake_30"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
os.rename("../statistic2/heft_local_search_1.csv", f"../statistic2/{ttt_name}_heft_local_search_1.csv")
os.rename("../statistic2/heft_local_search_2.csv", f"../statistic2/{ttt_name}_heft_local_search_2.csv")
os.rename("../statistic2/heft_local_search_3.csv", f"../statistic2/{ttt_name}_heft_local_search_3.csv")
os.rename("../statistic2/heft_iteration.csv", f"../statistic2/{ttt_name}_heft_iteration.csv")

ttt_name = "CyberShake_50"
file_name = "CyberShake_50"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
...
ttt_name = "CyberShake_100"
file_name = "CyberShake_100"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
...
ttt_name = "Epigenomics_24"
file_name = "Epigenomics_24"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
...
ttt_name = "Epigenomics_46"
file_name = "Epigenomics_46"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
...
ttt_name = "Epigenomics_100"
file_name = "Epigenomics_100"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
...
ttt_name = "Inspiral_30"
file_name = "Inspiral_30"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
...
ttt_name = "Inspiral_50"
file_name = "Inspiral_50"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
...
ttt_name = "Inspiral_100"
file_name = "Inspiral_100"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
...
ttt_name = "Montage_100"
file_name = "Montage_100"
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic2/heft_ttt.csv", f"../statistic2/{ttt_name}_heft_ttt.csv")
