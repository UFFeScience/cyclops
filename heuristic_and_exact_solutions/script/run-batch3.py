...
def exec_batch(arg_versions,
  ...
  for version in arg_versions:
    ...
    command = "../shell/run-" + version + "3.sh"
...
with open(output_file_name, "a") as f:
  f.write(file_name + "\n")
exec_dmer(repeat, file_name, "cluster_" + file_name)
os.rename("../statistic3/grasp_ttt.csv", f"../statistic3/{ttt_name}_grasp_ttt.csv")
os.rename("../statistic3/grasp_local_search_1.csv", f"../statistic3/{ttt_name}_grasp_local_search_1.csv")
os.rename("../statistic3/grasp_local_search_2.csv", f"../statistic3/{ttt_name}_grasp_local_search_2.csv")
os.rename("../statistic3/grasp_local_search_3.csv", f"../statistic3/{ttt_name}_grasp_local_search_3.csv")
os.rename("../statistic3/grasp_iteration.csv", f"../statistic3/{ttt_name}_grasp_iteration.csv")
